const list = $('#list').DataTable({
    ajax: {
        type: 'POST',
        url: baseUrl + 'dash/admin/layer7/list',
        data: {},
...
$(document).on('click', '.stopAttacks', function() {
    $.ajax({
        type: "POST",
        url: baseUrl + 'dash/admin/layer7/stopAllAttacks',
        data: {},
        headers: {'Content-type': 'application/x-www-form-urlencoded'},
        dataType: "json",
...
$(document).on('click', '.truncateList', function() {
    $.ajax({
        type: "POST",
        url: baseUrl + 'dash/admin/layer7/truncateList',
        data: {},
        headers: {'Content-type': 'application/x-www-form-urlencoded'},
        dataType: "json",
        success: function(data) {
...
function stopAttack(id) {
    $.ajax({
        type: "POST",
        url: baseUrl + 'dash/admin/layer7/stopAttack',
        data: {id: id},
        headers: {'Content-type': 'application/x-www-form-urlencoded'},
        dataType: "json",
        success: function(data) {
